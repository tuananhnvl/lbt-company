...
import partnerImage07 from '../asset/Edengate.png'
...
import partnerImage05 from '../asset/Ulupna.png'
import partnerImage06 from '../asset/Paxton.jpg'
    ...
    <>
      <div className='main-container-all' id='main-container-all' data-scroll-container>
        ...
        <div className='grid-wrapper' data-scroll-section>
          ...
          <div className='itemgrid-right-partners'>
            <div><div><img src={partnerImage06} alt='' /><a href='https://www.edengatewines.com.au/'>Explore</a></div></div>
          </div>
          <div className='itemgrid-left-partners'>
            <div><div><img src={partnerImage07} alt='' /><a href='https://www.ulupnawinery.com.au/'>Explore</a></div></div>
          </div>
        </div>
        <GetInTouch />
        <Footer />
